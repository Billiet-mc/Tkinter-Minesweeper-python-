...
╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚══════╝╚═════╝░░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝╚═╝░░░░░╚══════╝╚═╝░░╚═╝''', font='Arial 3').grid(row=0, column=0, columnspan=3)
    ...
    gameScreen.config(width=(int(buttons[0].winfo_width()) * int(userButtonDim[0])))
    gameScreen.config(height=(int(buttons[0].winfo_height()) * int(userButtonDim[1])))
    gameScreen.update()



    root.geometry(f"{(int(buttons[0].winfo_width()) * int(userButtonDim[0]))}x{(int(buttons[0].winfo_height()) * int(userButtonDim[1]))}")
